...
def create_mobilenetv2_model(class_names = class_names, IMG_SIZE = IMG_SIZE, LEARNING_RATE=LEARNING_RATE, dropout_rate=0.5):
...
global_model = create_mobilenetv2_model()
global_acc_list = []
global_loss_list = []
